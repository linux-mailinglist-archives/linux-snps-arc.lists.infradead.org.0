...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 36F30129D68
	for <lists+linux-snps-arc@lfdr.de>; Tue, 24 Dec 2019 05:38:38 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	References:List-Owner; bh=b0cuRnydNyTcj2Cu1d80PMObNCJNqyysRzzV42+QxSk=; b=ny/
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1ijbxn-0000LM-AB; Tue, 24 Dec 2019 04:38:31 +0000
Received: from foss.arm.com ([217.140.110.172])
 by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
 id 1ijbxZ-0000CG-DC; Tue, 24 Dec 2019 04:38:20 +0000
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
 by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id B0600328;
 Mon, 23 Dec 2019 20:38:12 -0800 (PST)
Received: from p8cg001049571a15.arm.com (unknown [10.163.1.130])
 by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPA id 8581C3F534;
 Mon, 23 Dec 2019 20:37:53 -0800 (PST)
From: Anshuman Khandual <anshuman.khandual@arm.com>
To: linux-mm@kvack.org
Subject: [PATCH V11 RESEND] mm/debug: Add tests validating architecture page
 table helpers
Date: Tue, 24 Dec 2019 10:08:42 +0530
Message-Id: <1577162322-30303-1-git-send-email-anshuman.khandual@arm.com>
X-Mailer: git-send-email 2.7.4
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20191223_203817_539977_85EEFD8D 
...
index b1b4476ddb83..c5d67b291da7 100644
...
index 5e8949953660..fd7b56932021 100644
--- a/arch/x86/Kconfig
+++ b/arch/x86/Kconfig
...
index ec3a1463ac69..ec5350d281ee 100644
--- a/init/main.c
+++ b/init/main.c
@@ -1210,6 +1210,7 @@ static noinline void __init kernel_init_freeable(void)
 	sched_init_smp();
...
index d1842fe756d5..b9e45e91e874 100644
--- a/lib/Kconfig.debug
+++ b/lib/Kconfig.debug
