...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 3D8C51FA10A
	for <lists+linux-snps-arc@lfdr.de>; Mon, 15 Jun 2020 22:15:01 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=4eRg+I/uWdwENQ3FyE3z7zmfEfqOVlj9J0W3roOiSJU=; b=K01TJItTmXaNTW
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1jkvVT-0003fi-NZ; Mon, 15 Jun 2020 20:14:59 +0000
Received: from smtprelay-out1.synopsys.com ([149.117.87.133])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1jkvVI-0003Xs-UA
 for linux-snps-arc@lists.infradead.org; Mon, 15 Jun 2020 20:14:57 +0000
Received: from mailhost.synopsys.com (sv2-mailhost1.synopsys.com
 [10.205.2.133])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits))
 (No client certificate requested)
 by smtprelay-out1.synopsys.com (Postfix) with ESMTPS id 8AF0DC0BB4;
 Mon, 15 Jun 2020 20:14:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=synopsys.com; s=mail;
 t=1592252088; bh=oXmPEiHKXwUsDY92BwpL2oKe+DJHb67G1UvWVOSNhwE=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
Received: from vineetg-Latitude-7400.internal.synopsys.com (unknown
 [10.13.183.89])
 by mailhost.synopsys.com (Postfix) with ESMTP id 24351A00A1;
 Mon, 15 Jun 2020 20:14:48 +0000 (UTC)
X-SNPS-Relay: synopsys.com
From: Vineet Gupta <Vineet.Gupta1@synopsys.com>
To: libc-alpha@sourceware.org
Subject: [PATCH v7 10/13] ARC: ABI lists
Date: Mon, 15 Jun 2020 13:14:38 -0700
Message-Id: <20200615201441.31820-11-vgupta@synopsys.com>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <20200615201441.31820-1-vgupta@synopsys.com>
References: <20200615201441.31820-1-vgupta@synopsys.com>
MIME-Version: 1.0
X-Spam-Note: CRM114 run bypassed due to message size (110190 bytes)
X-Spam-Score: -0.2 (/)
...
index 000000000000..00262925b75b
--- /dev/null
...
new file mode 100644
index 000000000000..260eacf1c337
--- /dev/null
...
new file mode 100644
index 000000000000..0fb0143ae746
--- /dev/null
...
new file mode 100644
index 000000000000..612a1e38b98a
--- /dev/null
...
new file mode 100644
index 000000000000..1adcbecc2e06
--- /dev/null
