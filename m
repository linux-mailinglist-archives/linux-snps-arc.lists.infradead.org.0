...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id B901D1CFD81
	for <lists+linux-snps-arc@lfdr.de>; Tue, 12 May 2020 20:45:19 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=eOQZp+iXz3z4JjWYF905y7rk2ZDOQ5mskA0uujf66yM=; b=VbQeXzZ3Awelo3
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1jYZu2-0003Nu-BP; Tue, 12 May 2020 18:45:18 +0000
Received: from mail.kernel.org ([198.145.29.99])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1jYZts-000292-QY; Tue, 12 May 2020 18:45:13 +0000
...
Subject: [PATCH 01/12] mm: don't include asm/pgtable.h if linux/mm.h is
 already included
...
MIME-Version: 1.0
X-Spam-Note: CRM114 run bypassed due to message size (135556 bytes)
X-Spam-Score: -5.4 (-----)
...
index 3bc7acc68ba8..8488b2e39ca7 100644
--- a/mm/swapfile.c
+++ b/mm/swapfile.c
@@ -40,7 +40,6 @@
 #include <linux/swap_slots.h>
